...
search_query = scholarly.search_author_id('qQvmBEEAAAAJ')
...
with sns.plotting_context('paper', font_scale=2):
  ...
  sns.histplot(
    pub, x='year', 
    ax=ax1, bins=len(cite['year'].unique()),
  ...
  ax1.text(
    0.8, 1.25, '{}'.format(date.today().strftime('%m/%d/%Y')),
    horizontalalignment='left',
    verticalalignment='center',
    fontweight='normal',
    fontsize=12,
  ...
  ax1.text(
    0.08, 1.15, '{}'.format(', '.join(interests)),
    horizontalalignment='left',
    verticalalignment='center',
    fontweight='normal',
    fontsize=12,
  ...
  ax2.text(
    -0.1, -0.45, '* This figure was automatically generated and could not perfectly reflect\n'
