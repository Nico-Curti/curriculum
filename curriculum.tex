...
\begin{tabular}{lp{4cm}lp{9cm}}
  ...
  \icon{0.05}{graduationcap.png} \quad 2023 & Andrea Corvina        & L-30  & \emph{Applicazione dell’algoritmo edsr disuper-resolution ad immagini inmicroscopia}\\
  ...
  %\icon{0.05}{graduationcap.png} \quad 2024 & Gaia Peroni           & L/SNT1 & \emph{}\\
\end{tabular}
...
%   \enumicon{0.05}{article.png} R. Biondi, A. A La Mattina, J. A Szyszko, S. Polizzi, D. Dall'Olio, \textbf{N. Curti}, G. Castellani, M. Viceconti, \paperTitle{A Semi-Automated and Unsupervised Method for femur segmentation from CT: Development and Validation on a Clinical Cohort}, \journal{???}, \url{???} (2024 ???)

%   \enumicon{0.05}{article.png} S. Dalmonte, M.A. Cocozza, D. Cuicchi, D. Remondini, \textbf{N. Curti$^\dagger$}, P. Castellucci, A. Farolfi, E. Fortunati, A. Cappelli, R. Biondi, A. Cattabriga, G. Poggioli, S. Fanti, F. Coppola, G. Castellani, \paperTitle{Identification of PET/CT radiomic signature for locally recurrent rectal cancer classification}, \journal{Cancers}, \url{???} (2024 ???)
