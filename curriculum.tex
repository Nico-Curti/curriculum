...
\begin{enumerate}
  ...
  \itemicon{0.05}{article.png}19. \textbf{N. Curti} \& G. Levi, E. Giampieri, G. Castellani, D. Remondini, \emph{A network approach for low-dimensional signatures from high-throughput data}, \emph{Scientific Reports}, \url{10.1038/s41598-022-25549-9} (2022 Nov 30)
...
%   \itemicon{0.05}{article.png} \textbf{N. Curti} \&, Y. Merli, C. Zengarini, A. Merlotti, D. Dall'Olio, E. Marcelli, G. Castellani, T. Bianchi, E. Giampieri, \emph{Effectiveness of semi-supervised active learning in automated wound image segmentation}, \emph{International Journal of Molecular Sciences}, \url{???} (2022 ???)
