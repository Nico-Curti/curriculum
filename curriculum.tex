...
\IfLanguageName{italian} {
  ...
  \begin{tabular}{lp{12cm}}
    ...
    \icon{0.05}{education.png} \quad 2020\textemdash2025 (5y) & Professore a contratto presso la Scuola di Scienze dell'Università di Bologna per il corso di laurea in Infermieristica (abilitante alla professione sanitaria di infermiere) per il corso di \emph{Fisica Applicata} - 58200 (24 ore). \\
...
\begin{longtable}{lp{15cm}}
  ...
  \qr{0.1}{10.3390_diagnostics15131675.png}     & R. Biondi, G. Gravante, D. Remondini, S. Peluso, S. Cominetti, F. D'Amore, M. Bignami, A.D. Arosio, \textbf{N. Curti}, \paperTitle{Towards Precision Medicine in Sinonasal Tumors: Low-Dimensional Radiomic Signature Extraction from MRI}, \journal{Diagnostics}, \url{https://doi.org/10.3390/diagnostics15131675} (2025 June 30) \\ % (I.F. 3.3)

  %\qr{0.1}{}                                    & T. Giacometti, \textbf{N. Curti$^\dagger$}, A. Zaghi, D. Remondini, G. Castellani, \paperTitle{Flow-Based Synthetic Data Generation: A Unified Approach for Biomedical Tasks}, \journal{1st Workshop on Artificial Intelligence for Biomedical Data (AIBio) 2025}, \url{} (2025 Aug 8)
...
%   \qr{0.1}{article.png} & \textbf{N. Curti} \& L. Dall'Olio, G. Veronesi, G. Querzoli, F. Venturi, A. Sisi, S. Peluso, G. Castellani, E. Dika, \paperTitle{Towards Accurate Breslow Measurement: Mitigating Issues in Histopathological Imaging}, \journal{???}, \url{???} (2024 ???) \\ %(I.F. 9.2)

%   \qr{0.1}{article.png} & L. Dall'Olio, D. Griffa, C. Zengarini, Y. Merli, L. Rapparini, B.M. Piraccini, M. Starace, G. Castellani, D. Remondini, \textbf{N. Curti}, \paperTitle{Automated 3D Wound Surface Area Estimation: Novel Computer Vision Approaches for Clinical Application}, \journal{???}, \url{???} (2024 ???) \\ % (I.F. ???)
