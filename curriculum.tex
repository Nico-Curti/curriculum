...
\begin{itemize}
  ...
  \itemicon{0.03}{conference.png} \textbf{Mentor Coach} \alla \conferenza \emph{AI Hackathon X Oncologia - Microsoft HQ Milan}, \il 03/12/2024.
...
\begin{longtable}{lp{15cm}}
  ...
  \\
  \qr{0.1}{article.png} & D. Dall'Olio, F. Magnani, F. Casadei, T. Matteuzzi, \textbf{N. Curti}, A. Merlotti, G. Simonetti, M.G. Della Porta, D. Remondini, M. Tarozzi, G. Castellani, \paperTitle{Emerging Signatures of Hematological Cancers from Gene Expression and Gene Regulations}, \journal{International Journal of Molecular Sciences}, \url{???} (2024 Dec ???) \\ %(I.F. 5.6)
  \\
  \qr{0.1}{article.png} & G. Gravante, A.D. Arosio, \textbf{N. Curti}, R. Biondi, L. Berardi, A. Gandolfi, M. Turri-Zanoni, P. Castelnuovo, D. Remondini, M. Bignami, \paperTitle{Artificial intelligence and MRI in sinonasal tumors discrimination: where do we stand?}, \journal{European Archives of Oto-Rhino-Laryngology}, \url{???} (2024 Dec ???) \\ % (I.F. 1.9)
