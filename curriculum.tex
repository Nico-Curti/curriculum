...
\begin{tabular}{lp{4cm}lp{9cm}}
  ...
  %\icon{0.05}{graduationcap.png} \quad 2023 & Andrea Corvina        & L-DM270  & \emph{}\\
  %\icon{0.05}{degree.png}        \quad 2023 & Sara Peluso           & LM-DM270 & \emph{}\\
  %\icon{0.05}{degree.png}        \quad 2023 & Alessandro Lapi       & LM-DM270 & \emph{}\\
  %\icon{0.05}{degree.png}        \quad 2024 & Simone Chiarella      & LM-DM270 & \emph{}\\
  %\icon{0.05}{degree.png}        \quad 2024 & Alessandro Ceresi     & LM-DM270 & \emph{}\\
\end{tabular}
