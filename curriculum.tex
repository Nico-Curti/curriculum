...
\begin{tabular}{lp{4cm}lp{9cm}}
  ...
  \icon{0.05}{graduationcap.png} \quad 2023 & Andrea Corvina        & L-DM270  & \emph{Applicazione dell’algoritmo edsr disuper-resolution ad immagini inmicroscopia}\\
  \icon{0.05}{degree.png}        \quad 2023 & Sara Peluso           & LM-DM270 & \emph{Survival analysis in radiomics: a statistical learning approach on 18F-FDG-PET/CT imaging data of patients affected by multiple myeloma}\\
  \icon{0.05}{degree.png}        \quad 2023 & Alessandro Lapi       & LM-DM270 & \emph{Artificial intelligence application in Digital Onco-Hematology}\\
  %\icon{0.05}{degree.png}        \quad 2024 & Simone Chiarella      & LM-DM270 & \emph{}\\
\end{tabular}
...
%   \enumicon{0.05}{article.png} \textbf{N. Curti} \& Y. Merli, C. Zengarini, A. Merlotti, D. Dall'Olio, E. Marcelli, G. Castellani, T. Bianchi, E. Giampieri, \paperTitle{Automated prediction of Photographic Wound Assessment Tool in Chronic Wound images}, \journal{???}, \url{???} (2023 ???)

%   \enumicon{0.05}{article.png} \textbf{N. Curti} \& G. Carlini, S. Valente, E. Giampieri, A. Merlotti, D. Dall'Olio, C. Sala, E. Marcelli, G. Castellani, G. Pasquinelli, \paperTitle{Fully automated estimation of glomerular basement membrane thickness via active semi-supervised learning model}, \journal{???}, \url{???} (2023 ???)

%   \enumicon{0.05}{article.png} R. Biondi, A. A La Mattina, J. A Szyszko, S. Polizzi, D. Dall'Olio, \textbf{N. Curti}, G. Castellani, M. Viceconti, \paperTitle{A Semi-Automated and Unsupervised Method for femur segmentation from CT: Development and Validation on a Clinical Cohort}, \journal{???}, \url{???} (2023 ???)

%   \enumicon{0.05}{article.png} S. Dalmonte, M.A. Cocozza, D. Cuicchi, D. Remondini, \textbf{N. Curti$^\dagger$}, R. Biondi, A. Cattabriga, G. Poggioli, P. Castellucci, S. Fanti, F. Coppola, G. Castellani, \paperTitle{Identification of radiomic signature for locally recurrent rectal cancer classification}, \journal{Cancers}, \url{???} (2024 ???)
