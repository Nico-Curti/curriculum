...
\begin{tabular}{clp{11cm}l}

  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{DNetPRO}         & \emph{Discriminant Analysis with Network PROcessing}                        & \href{https://github.com/Nico-Curti/DNetPRO}{github} \\
  \icon{0.025}{python.png}                       & \scshape{NumPyNet}        & \emph{Neural Networks library in pure numpy}                                & \href{https://github.com/Nico-Curti/NumPyNet}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{Openslide}       & \emph{C library for reading virtual slide images}                           & \href{https://github.com/Nico-Curti/Openslide}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{Byron}           & \emph{Build your own neural network}                                        & \href{https://github.com/Nico-Curti/Byron}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{rFBP}            & \emph{Replicated Focusing Belief Propagation algorithm}                     & \href{https://github.com/Nico-Curti/rFBP}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{plasticity}      & \emph{Unsupervised Neural Networks with biological-inspired learning rules} & \href{https://github.com/Nico-Curti/plasticity}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{scorer}          & \emph{Machine Learning Scorer Library}                                      & \href{https://github.com/Nico-Curti/scorer}{github} \\
  \icon{0.025}{cpp.png}                          & \scshape{ParseArgs}       & \emph{Simple command line parser in C++}                                    & \href{https://github.com/Nico-Curti/ParseArgs}{github} \\
  \icon{0.025}{cpp.png}                          & \scshape{easyDAG}         & \emph{Simple template DAG scheduler in c++}                                 & \href{https://github.com/Nico-Curti/easyDAG}{github} \\
  \icon{0.025}{cpp.png}                          & \scshape{genetic}         & \emph{Examples about genetic algorithms for parallel computing}             & \href{https://github.com/Nico-Curti/genetic}{github} \\
  \icon{0.020}{bash.jpg} \icon{0.05}{pwsh.png}   & \scshape{shut}            & \emph{Shell Utilities and Installers for no root users}                     & \href{https://github.com/Nico-Curti/shut}{github} \\
  \icon{0.025}{python.png}                       & \scshape{cardio}          & \emph{Pulse oximetry data processing and classification}                    & \href{https://github.com/Nico-Curti/cardio}{github} \\
  \icon{0.025}{python.png}                       & \scshape{BlendNet}        & \emph{Network viewer with Blender support}                                  & \href{https://github.com/Nico-Curti/BlendNet}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{SysDyn}          & \emph{System Dynamics script utilities}                                     & \href{https://github.com/Nico-Curti/SysDyn}{github} \\
  \icon{0.025}{cpp.png}                          & \scshape{nocs}            & \emph{NOCS (Not Only Colliding Spheres) exact 2D gas dynamics framework}    & \href{https://github.com/Nico-Curti/nocs}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{rSGD}            & \emph{Replicated Stochastic Gradient Descent algorithm}                     & \href{https://github.com/Nico-Curti/rSGD}{github} \\
  \icon{0.025}{cpp.png} \icon{0.025}{python.png} & \scshape{Walkers}         & \emph{Random Walk and Optimizer Simulator}                                  & \href{https://github.com/Nico-Curti/Walkers}{github} \\
  \icon{0.025}{python.png}                       & \scshape{CryptoSocket}    & \emph{TCP/IP Client Server with RSA cryptography}                           & \href{https://github.com/Nico-Curti/CryptoSocket}{github} \\
  \icon{0.025}{python.png}                       & \scshape{FiloBluService}  & \emph{FiloBlu Service Manager for text message processing}                  & \href{https://github.com/Nico-Curti/FiloBluService}{github} \\
  \icon{0.025}{python.png}                       & \scshape{anonymize-slide} & \emph{Delete the label from a whole-slide image}                            & \href{https://github.com/Nico-Curti/anonymize-slide}{github} \\
