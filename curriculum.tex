...
%   \qr{0.1}{article.png} & G. Veronesi \& \textbf{N. Curti}, A. Gardini, G. Castellani, E. Dika, \paperTitle{A machine learning pipeline in melanoma classification: analysis of nuclei morphology and their spatial organization}, \journal{???}, \url{???} (2024 ???) \\ % (I.F. ???)
...
%   \qr{0.1}{article.png} & R. Biondi, S. Peluso, G. Gravante, A.D. Arosio, D. Remondini, \textbf{N. Curti}, \paperTitle{Towards Precision Medicine in Sinonasal Tumors: Low-Dimensional Radiomic Signature Extraction from MRI}, \journal{???}, \url{???} (2025 ???) \\ % (I.F. ???)
